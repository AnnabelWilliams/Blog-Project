					...
					<div class="card bg-secondary text-light mb-3">
						<div class="card-body bg-dark">
							<div class="form-group">
								...
								<input class="form-control" type="text" name="PostTitle" id="title" placeholder="Type title here" value="<?php echo $PostTitleUpdate;?>"></input>
							</div>
							<div class="form-group">
								<span class="FieldInfo">Existing Category: </span>
								<?php echo $CategoryNameUpdate."<br>"; ?>
							...
							<div class="form-group">
								...
								<textarea class="form-control" id="Post" name="Post" rows="8" cols="80"><?php echo $PostContentUpdate;?></textarea>
							</div>
							<div class="row">
